...
class ConfirmFriendsDetails extends StatefulWidget {
  const ConfirmFriendsDetails({super.key, required this.userDetails});
...
class _ConfirmFriendsDetailsState extends State<ConfirmFriendsDetails> {
  ...
  void loadInfo() {
    ...
    _fullNamesController.text = (details["name"]! as String).title();
          ...
          slivers: [
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                title: Text(
                  "Hi there ${widget.userDetails['name']?.split(' ').first}!",
